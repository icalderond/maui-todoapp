...
namespace TodoApp.WebAPI.Migrations
{
    ...
    [Migration("20240122025254_fixModelsProp")]
    partial class fixModelsProp
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TodoApp.Shared.Models.ToDoItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Title = "My Note",
                            UpdateDate = new DateTime(2024, 1, 21, 20, 52, 54, 280, DateTimeKind.Local).AddTicks(6350)
                        },
                        new
                        {
                            Id = 2,
                            Content = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
                            Title = "My Note 2",
                            UpdateDate = new DateTime(2024, 1, 21, 20, 52, 54, 280, DateTimeKind.Local).AddTicks(6430)
                        });
                });
